...
<form name='search' action='search.php'>
        <p>
                ...
                <input type="text" name="search" id="search" value="" size="18" maxlength="100" style="color:#22211f;">
                <input type="submit" value="search" class="submit"  style="color:#22211f;">
        </p>
</form>
...
<td><label>Username</label></td>
   <td colspan="2"><span class="style8">
     <div align="center">
		  ...
		  ?>
          <select name="stud_id" style="width:250px; height:34px; border:1px solid #336666; color:#22211f;">
...
<tr>
    ...
    <td><select name="rank" id="rank" style="width:250px; height:34px; border:1px solid #336666; color:#22211f;">
...
<tr><td colspan="2" align="left"><input type="submit" name="register" value="Update" style="width:100px; height:34px; border:1px solid #336666; color:#22211f; border-radius:4px;"></td></tr>
				 </table>
			    </div>
</form>
