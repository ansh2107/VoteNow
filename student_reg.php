...
<tr><td><label>Firstname</label></td>
    <td><input type="text" name="firstname" value="" style="width:250px; height:34px; border:1px solid #336666; color:#22211f;"/></td>
</tr>
<tr><td><label>Lastname</label></td>
    <td><input type="text" name="lastname" value="" style="width:250px; height:34px; border:1px solid #336666; color:#22211f;"/></td>
</tr>
<tr><td><label>Username</label></td>
    <td><input type="text" name="username" value="" style="width:250px; height:34px; border:1px solid #336666; color:#22211f;"/></td>
</tr>
<tr><td><label>Password</label></td>
    <td><input type="password" name="password" value="" style="width:250px; height:34px; border:1px solid #336666; color:#22211f;"/></td>
</tr>
<tr>
    <td><label>Course</label></td>
    <td><select name="course" id="course" style="width:250px; height:34px; border:1px solid #336666; color:#22211f; ">
...
<tr><td><label>Registration Number</label></td>
    <td><input type="text" name="stud_id" value="" style="width:250px; height:34px; border:1px solid #336666; color:#22211f;"/></td>
</tr>
<tr>
    <td><label>Year Of study</label></td>
    <td><select name="yos" id="yos" style="width:250px; height:34px; border:1px solid #336666; color:#22211f;">
...
<tr><td colspan="2" align="left"><input type="submit" name="submit" value="Next" style="width:100px; height:34px; border:1px solid #336666; border-radius:4px; color:#22211f;"></td></tr>
				 </table>
			    </div>
</form>
