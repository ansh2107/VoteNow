...
<div class="jumbotron" >
  ...
  <img src="candidates/Captur.png  "  height="150" width="1350"/>
</div>
<h3><marquee style="color:#22211f;">Speak it out through voting-2015</marquee></h3>
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="login_reg.php">Student Election Portal</a>
    </div>
    <div>
      <ul class="nav navbar-nav">
        
        <li class="active"><a href="login_reg.php">Register</a></li>
