...
<tr><td><label>Display Name</label></td>
    <td><input type="text" name="display_name" value="" style="width:250px; height:34px; border:1px solid #336666; color:#22211f;"/></td>
</tr>

<tr><td><label>Question</label></td>
    <td><textarea cols='30' rows='10' type="text" name="qn" value="qn" style="width:250px; height:34px; border:1px solid #336666; color:#22211f;"/>Question...</textarea>
    </td>
</tr>
<tr>
    <td><label>Select Candidate for question</label></td>
    <td><select name="cand_id" id="cand_id" style="color:#22211f;">
    <option value="000">Candidate</option>
    <option value="1">First Candidate</option>
    <option value="2">Second Candidate</option>
    </select></td>
</tr>
<tr><td colspan="2" align="left"><input type="submit" name="submit" value="Post" style="width:100px; height:34px; border:1px solid #336666; border-radius:4px; color:#22211f;"></td></tr>
				 </table>
			    </div>
</form>
