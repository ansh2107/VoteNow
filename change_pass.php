...
<tr><td><label>Current-Username</label></td>
    <td><input type="text" name="cusername" value="" style="width:250px; height:34px; border:1px solid #336666;color:#22211f;"/></td>
</tr>				
...
<tr><td colspan="2" align="left"><input type="submit" name="Change-pass" value="Change" style="width:100px; color:#22211f; height:34px; border:1px solid #336666; border-radius:4px;"></td></tr>
				 </table>
			    </div>
</form>
